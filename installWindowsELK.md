# How to install ELK Stack (Elasticsearch + Logstash + Kibana)
...
For my use, I had to install elasticsearch as a service : 
```
...
Problem : kibana and logstash are not services. So when I start kibana, I cannot start logstash at the same time. You need to open 2 command prompt
